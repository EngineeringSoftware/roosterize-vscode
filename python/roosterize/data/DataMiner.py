...
class DataMiner:
    ...
    def collect_lemmas_doc(cls,
        ...
        lemma_qnames_backend_sexps_str: str = BashUtils.run(f"sername --require-lib={qprefix_this_doc} {serapi_options} {lemma_qnames_file}", expected_return_code=0).stdout
